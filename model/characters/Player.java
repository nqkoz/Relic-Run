...
public class Player extends CharacterBase {
    ...
    public void setStatus(StatusState s) {
        this.status = s;
    }
    ...
    public boolean move(String dir) {
        ...
        if (next == null)
            return false;
        currentRoom = next;
        notifyObservers("move:" + next.getId());
        return true;
    }
